...
export const STRINGS = {
  en: {
    ...
    'live.title': 'Record',
    'live.sub': 'Records from your microphone, then transcribes the complete recording — so you get <strong>every sentence and speaker separation</strong>, exactly like uploading a file. Live captions appear while you record as a rough preview; the accurate transcript replaces them when you stop.',
    'live.lang': 'Preview language',
    'live.start': '● Start recording',
    'live.stop': '■ Stop and transcribe',
    'live.recording': 'Recording… every word is being captured to audio.',
  ...
  zh: {
    ...
    'live.title': '录音',
    'live.sub': '先录制麦克风音频，再对完整录音进行转写 — 因此能获得<strong>每一句话以及说话人分离</strong>，效果与上传文件完全一致。录音过程中会显示实时字幕作为粗略预览，停止后将由准确的文字稿替换。',
    'live.lang': '预览语言',
    'live.start': '● 开始录音',
    'live.stop': '■ 停止并转写',
    'live.recording': '正在录音… 每一句话都会被完整录下。',
